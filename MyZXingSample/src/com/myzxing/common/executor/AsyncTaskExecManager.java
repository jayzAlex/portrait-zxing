...
package com.myzxing.common.executor;

import com.myzxing.common.PlatformSupportManager;
...
public final class AsyncTaskExecManager extends PlatformSupportManager<AsyncTaskExecInterface> {
  ...
  public AsyncTaskExecManager() {
    ...
    addImplementationClass(11, "com.myzxing.common.executor.HoneycombAsyncTaskExecInterface");
  }
